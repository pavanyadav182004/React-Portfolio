  ...
  return (
    <div className="[perspective:1200px] [transform-style:preserve-3d]">
      <li
        ...
        <div
          className="absolute top-20 left-0 w-full h-80 bg-[#1D1F2F] rounded-[1%] overflow-hidden transition-all duration-150 ease-out"
          style={{
            transform:
              current === index
        ...
        <article
          ...
          <div className="flex justify-center">
            <button
              className="mt-6  px-5 py-2 w-fit mx-auto sm:text-sm text-black bg-white hover:bg-white/80 h-12 border border-transparent text-xs flex justify-center items-center rounded-2xl hover:shadow-lg transition duration-200 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
